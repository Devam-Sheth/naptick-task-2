...
def run_conversation():
    ...
    welcome_message = "Kem cho! This is your Sleep AI assistant made by Devam Sheth who studies in BITS Pilani, Pilani Campus.Say 'exit' or 'goodbye' to end our chat."
    print(f"Devam's Assistant: {welcome_message}")
    ...
    while True:
        ...
        if should_exit:
            farewell = "Okay, ending now. Sleep well!"; print(f"Devam's Assistant: {farewell}")
        ...
        print(f"Devam's Assistant Assistant: {assistant_reply}")
